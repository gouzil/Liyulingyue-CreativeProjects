    ...
    def split(self, fixed_k: int | None = None) -> ModelManifest:
        ...
        manifest = ModelManifest(
            ...
            extra_config={
                ...
                "moe_norm_min": config.get("moe_norm_min", 1e-12),
                "moe_layer_start_index": config.get("moe_layer_start_index"),
                "moe_layer_end_index": config.get("moe_layer_end_index"),
                "moe_layer_interval": config.get("moe_layer_interval"),
                "keep_in_fp32": ["gate.weight", "moe_statics"],
            },
